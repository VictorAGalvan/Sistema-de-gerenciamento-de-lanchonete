...
ALTER TABLE pedidos ADD FOREIGN KEY(idPessoas) REFERENCES pessoas (id);
...
SELECT 'João da Silva', '11111111111', '54999990001', 'joao@email.com'
WHERE NOT EXISTS (
    SELECT 1 FROM clientes WHERE cpf = '11111111111'
);

INSERT INTO clientes (nome, cpf, telefone, email)
SELECT 'Maria Oliveira', '22222222222', '54999990002', 'maria@email.com'
WHERE NOT EXISTS (
    SELECT 1 FROM clientes WHERE cpf = '22222222222'
);

INSERT INTO clientes (nome, cpf, telefone, email)
SELECT 'Carlos Souza', '33333333333', '54999990003', 'carlos@email.com'
WHERE NOT EXISTS (
    SELECT 1 FROM clientes WHERE cpf = '33333333333'
);

INSERT INTO clientes (nome, cpf, telefone, email)
SELECT 'Ana Pereira', '44444444444', '54999990004', 'ana@email.com'
WHERE NOT EXISTS (
    SELECT 1 FROM clientes WHERE cpf = '44444444444'
);
...
INSERT INTO itens (preco, categoria, nome)
SELECT 25.90, 'L', 'Hambúrguer Artesanal'
WHERE NOT EXISTS (
    SELECT 1 FROM itens WHERE nome = 'Hambúrguer Artesanal'
);

INSERT INTO itens (preco, categoria, nome)
SELECT 18.90, 'L', 'X-Bacon'
WHERE NOT EXISTS (
    SELECT 1 FROM itens WHERE nome = 'X-Bacon'
);

INSERT INTO itens (preco, categoria, nome)
SELECT 12.00, 'B', 'Batata Frita'
WHERE NOT EXISTS (
    SELECT 1 FROM itens WHERE nome = 'Batata Frita'
);

INSERT INTO itens (preco, categoria, nome)
SELECT 8.50, 'B', 'Refrigerante Lata'
WHERE NOT EXISTS (
    SELECT 1 FROM itens WHERE nome = 'Refrigerante Lata'
);

INSERT INTO itens (preco, categoria, nome)
SELECT 22.90, 'S', 'Milk Shake'
WHERE NOT EXISTS (
    SELECT 1 FROM itens WHERE nome = 'Milk Shake'
);
...
INSERT INTO Ingredientes (nome, unidade, quantidade)
SELECT 'Pão de hambúrguer', 1, 100
WHERE NOT EXISTS (
    SELECT 1 FROM Ingredientes WHERE nome = 'Pão de hambúrguer'
);

INSERT INTO Ingredientes (nome, unidade, quantidade)
SELECT 'Carne bovina', 1, 100
WHERE NOT EXISTS (
    SELECT 1 FROM Ingredientes WHERE nome = 'Carne bovina'
);

INSERT INTO Ingredientes (nome, unidade, quantidade)
SELECT 'Bacon', 1, 80
WHERE NOT EXISTS (
    SELECT 1 FROM Ingredientes WHERE nome = 'Bacon'
);

INSERT INTO Ingredientes (nome, unidade, quantidade)
SELECT 'Queijo', 1, 100
WHERE NOT EXISTS (
    SELECT 1 FROM Ingredientes WHERE nome = 'Queijo'
);

INSERT INTO Ingredientes (nome, unidade, quantidade)
SELECT 'Batata', 1, 200
WHERE NOT EXISTS (
    SELECT 1 FROM Ingredientes WHERE nome = 'Batata'
);

INSERT INTO Ingredientes (nome, unidade, quantidade)
SELECT 'Leite', 1, 100
WHERE NOT EXISTS (
    SELECT 1 FROM Ingredientes WHERE nome = 'Leite'
);
...
INSERT INTO cardapios (data, versao)
...
INSERT INTO pedidos (idClientes, mesa)
SELECT p.id, 1
FROM clientes p
...
INSERT INTO itensCardapio (idCardapio, idItens)
SELECT c.id, i.id
FROM cardapios c
CROSS JOIN itens i
...
INSERT INTO itensIngredientes (idIngredientes, idItens)
SELECT ing.id, i.id
...
JOIN clientes pe ON pe.id = p.idClientes
